...
declare namespace load {
    ...
    export interface WebSocketSendOptions {
        /**
         * The data to send. It can be either a string or a binary array buffer.
         */
        data: string,
        /**
        ...
        /**
         * The default is false, must be set to true when _data_ or the content _dataPath_ of is binary
         */
        isBinary: boolean
    }
    ...
    export class WebSocket {
         ...
         * In order to send a binary message, _isBinary_ should be set to _true_ otherwise a string message is sent.
         *
         * @param {*} data - The data to send. It can be either a string or a binary array buffer.
         * @param {boolean} isBinary - The default is false, must be set to true when _data_ is binary
         * @memberof WebSocket
         */
    ...
    export interface WebRequestOptions {
         ...
         * For request with content-type ```text\plain```: If body equals ```{"foo":"bar", "bat":10}``` and formDelimiter is a newline character (\r\n), it is converted to:
         * ```foo=bar
         * bat=10
         * ```
         * For request with content-type ```application/json```:If body equals ```{"foo":"bar", "bat":10}``` it is converted to ```'{"foo":"bar", "bat":10}'```.
         */
        body: string | Object,
        /**
        ...
        /**
         * When defined ```WebRequest``` will be automatically signed with AWS Signature Version 4 using the credentials provided by the ```load.setUserCredentials``` API.
    ...
    /**
     * Registers the given _callback_ as a named initialize of the script with the given _name_. The initializes will be run in the same order as they are registered by calls to load.initialize() or by the order defined in the run logic. The _callback_ may return a promise that will be used to determine if the _callback_ has succeeded or failed.
     *
     * @export
     * @param {string} name
    ...
    /**
     * Registers the given _callback_ to be run in the initialization phase of the test. The _callback_ may return a promise that will be used to determine if the _callback_ has succeeded or failed.
     *
     * @export
     * @param {async function} callback
     */
    ...
    /**
     *Registers the given _callback_ as a named action of the script with the given _name_. The actions will be run in the same order as they are registered by calls to load.action() or by the order defined in the run logic. The _callback_ may return a promise that will be used to determine if the _callback_ has succeeded or failed.
     *
     * @export
     * @param {string} name
    ...
    /**
     * Registers the given _callback_ to be run in the action phase of the test. The _callback_ may return a promise
     * that will be used to determine if the _callback_ has succeeded or failed. The actions will be run in the same
     * order as they are registered by calls to load.action().
     *
     * @export
     * @param {function} callback
     */
    ...
    /**
     * Registers the given _callback_ as a named finalize of the script with the given _name_. The finalizes will be run in the same order as they are registered by calls to load.finalize() or by the order defined in the run logic. The _callback_ may return a promise that will be used to determine if the _callback_ has succeeded or failed.
     *
     * @export
     * @param {string} name
     * @param {function} callback
    ...
    /**
     *Registers the given _callback_ to be run in the finalization phase of the test. The _callback_ may return a promise which will be used to determine if the _callback_ has succeeded or failed.
     *
     * @export
     * @param {function} callback
     */
    ...
    export class AWSAuthentication {
         ...
         * @param providerType An AWS authentication provider type.
         * @param options An options based on provider type.
         */
     ...
     *
     */
    export function CookieExtractor(name: string, options: CookieExtractorOptions);
    ...
    export class VTSClient {
         ...
         * exists but the index must be a non-negative number.
         * @param rowIndex
         */
    ...
    export class Timer {
         ...
         *
         * Each setTimeout must we followed by _timer.wait()_ or there may be undefined behavior when the timer is used.
     ...
     * This capability is available under LRC\LRP execution only.
