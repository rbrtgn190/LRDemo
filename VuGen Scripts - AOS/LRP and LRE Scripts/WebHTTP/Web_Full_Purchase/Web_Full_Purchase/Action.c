...
/*Correlation comment - Do not change!  Original value='519.99' Name ='CorrelationParameter' Type ='RecordReplay'*/
...
/*Correlation comment - Do not change!  Original value='C3C3C3' Name ='CorrelationParameter_1' Type ='RecordReplay'*/
	web_reg_save_param_json(
...
/*Correlation comment - Do not change!  Original value='E464A8C4EDD15715F974EACACE2C76A4' Name ='sessionId' Type ='ResponseBased'*/
