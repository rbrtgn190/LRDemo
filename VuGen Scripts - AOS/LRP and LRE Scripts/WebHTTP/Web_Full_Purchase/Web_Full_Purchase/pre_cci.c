# 1 "c:\\dev\\lrdemo\\vugen scripts - aos\\lrp and lre scripts\\webhttp\\web_full_purchase\\web_full_purchase\\\\combined_Web_Full_Purchase.c"
...
# 1 "c:\\dev\\lrdemo\\vugen scripts - aos\\lrp and lre scripts\\webhttp\\web_full_purchase\\web_full_purchase\\\\combined_Web_Full_Purchase.c" 2
...
# 2 "c:\\dev\\lrdemo\\vugen scripts - aos\\lrp and lre scripts\\webhttp\\web_full_purchase\\web_full_purchase\\\\combined_Web_Full_Purchase.c" 2
...
# 3 "c:\\dev\\lrdemo\\vugen scripts - aos\\lrp and lre scripts\\webhttp\\web_full_purchase\\web_full_purchase\\\\combined_Web_Full_Purchase.c" 2
...
# 4 "c:\\dev\\lrdemo\\vugen scripts - aos\\lrp and lre scripts\\webhttp\\web_full_purchase\\web_full_purchase\\\\combined_Web_Full_Purchase.c" 2
...
# 65 "Action.c"
	...
	web_custom_request("GetAccountConfigurationRequest", 
		"URL=http://{URL}/accountservice/ws/GetAccountConfigurationRequest", 
		"Method=POST", 
		"Resource=0", 
	...
	web_reg_save_param_json(
		...
		"QueryString=$[0].products[4].price",
		"SEARCH_FILTERS",
		"Scope=Body",
		"LAST");
	...
	web_reg_save_param_json(
		...
		"QueryString=$[0].products[4].colors[2].code",
		"SEARCH_FILTERS",
		"Scope=Body",
		"LAST");
	...
	web_custom_request("AccountLoginRequest", 
		"URL=http://{URL}/accountservice/ws/AccountLoginRequest", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=text/xml", 
		"Referer=http://{URL}/", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountLoginRequest xmlns=\"com.advantage.online.store.accountservice\"><email></email><loginPassword>{UserPassword}</loginPassword><loginUser>{Username}</loginUser></AccountLoginRequest></soap:Body></soap:Envelope>", 
		"LAST");
	...
	web_url("search-page.html", 
		"URL=http://{URL}/app/views/search-page.html", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=http://{URL}/", 
		"Snapshot=t14.inf", 
	...
	web_url("product-page.html", 
		"URL=http://{URL}/app/views/product-page.html", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=http://{URL}/", 
		"Snapshot=t17.inf", 
	...
	lr_end_transaction("select_item",2);
	...
	web_submit_data("C3C3C3",
		"Action=http://{URL}/order/api/v1/carts/741696325/product/1/color/{CorrelationParameter_1}?quantity=1",
		"Method=POST",
		"RecContentType=application/json",
		"Referer=http://{URL}/",
		"Snapshot=t18.inf",
	...
	web_url("shoppingCart.html", 
		"URL=http://{URL}/app/views/shoppingCart.html", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=http://{URL}/", 
		"Snapshot=t20.inf", 
	...
	web_custom_request("GetAccountByIdRequest", 
		"URL=http://{URL}/accountservice/GetAccountByIdRequest", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=text/xml", 
		"Referer=http://{URL}/", 
	...
	web_custom_request("GetAccountByIdNewRequest", 
		"URL=http://{URL}/accountservice/GetAccountByIdNewRequest", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=text/xml", 
		"Referer=http://{URL}/", 
	...
	web_custom_request("shippingcost",
		"URL=http://{URL}/order/api/v1/shippingcost/",
		"Method=POST",
		"Resource=0",
		"RecContentType=application/json",
		"Referer=http://{URL}/",
		...
		"Body={\"seaddress\":{\"addressLine1\":\"address\",\"addressLine2\":\"\",\"city\":\"New York\",\"country\":\"us\",\"postalCode\":10017,\"state\":\"NY\"},\"secustomerName\":\"John Smith\",\"secustomerPhone\":\"480-222-1111\",\"senumberOfProducts\":1,\"setransactionType\":\"SHIPPING_COST\",\"sessionId\":\"{sessionId}\"}",
		"LAST");
	...
	web_custom_request("GetAccountPaymentPreferencesRequest", 
		"URL=http://{URL}/accountservice/GetAccountPaymentPreferencesRequest", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=text/xml", 
		"Referer=http://{URL}/", 
	...
	web_url("orderPayment-page.html", 
		"URL=http://{URL}/app/order/views/orderPayment-page.html", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=http://{URL}/", 
		"Snapshot=t26.inf", 
	...
	web_custom_request("UpdateSafePayMethodRequest", 
		"URL=http://{URL}/accountservice/UpdateSafePayMethodRequest", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=text/xml", 
		"Referer=http://{URL}/", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><UpdateSafePayMethodRequest xmlns=\"com.advantage.online.store.accountservice\"><userId>741696325</userId><safePayUsername>{Username}</safePayUsername><safePayPassword>{PaymentPassword}</safePayPassword><referenceId>1234567890</referenceId><base64Token>Basic YWRtaW46YWRtMW4=</"
	...
	web_custom_request("741696325_5",
		"URL=http://{URL}/order/api/v1/orders/users/741696325",
		"Method=POST",
		"Resource=0",
		"RecContentType=application/json",
		"Referer=http://{URL}/",
		...
		"Body={\"orderPaymentInformation\":{\"Transaction_AccountNumber\":\"843200971\",\"Transaction_Currency\":\"USD\",\"Transaction_CustomerPhone\":\"480-222-1111\",\"Transaction_MasterCredit_CVVNumber\":\"\",\"Transaction_MasterCredit_CardNumber\":\"4886\",\"Transaction_MasterCredit_CustomerName\":\"\",\"Transaction_MasterCredit_ExpirationDate\":\"122027\",\"Transaction_PaymentMethod\":\"SafePay\",\"Transaction_ReferenceNumber\":0,\"Transaction_SafePay_Password\":\"{PaymentPassword}\",\"Transaction_SafePay_UserName\":\"{Username}\",\"Transaction_TransactionDate\":\"04112019\",\"Transaction_Type\":\"PAYMENT\"},\"orderShippingInformation\":{\"Shipping_Address_Address\":\"address\",\"Shipping_Address_City\":\"New York\",\"Shipping_Address_CountryCode\":40,\"Shipping_Address_CustomerName\":\"John Smith\",\"Shipping_Address_CustomerPhone\":\"480-222-1111\",\"Shipping_Address_PostalCode\":10017,\"Shipping_Address_State\":\"NY\",\"Shipping_Cost\":{CorrelationParameter},\"Shipping_NumberOfProducts\":1,\"Shipping_TrackingNumber\":0},\"pur"
		"chasedProducts\":[{\"hexColor\":\"{CorrelationParameter_1}\",\"productId\":1,\"quantity\":1}]}",
		"LAST");
	...
	lr_end_transaction("check_out",2);
...
# 5 "c:\\dev\\lrdemo\\vugen scripts - aos\\lrp and lre scripts\\webhttp\\web_full_purchase\\web_full_purchase\\\\combined_Web_Full_Purchase.c" 2
...
# 6 "c:\\dev\\lrdemo\\vugen scripts - aos\\lrp and lre scripts\\webhttp\\web_full_purchase\\web_full_purchase\\\\combined_Web_Full_Purchase.c" 2
