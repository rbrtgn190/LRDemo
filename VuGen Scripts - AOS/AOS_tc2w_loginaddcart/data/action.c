Action()
{
	...
	web_submit_data("414141", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=sessionId", "Value=8C0083850F93ED62C4C2DD7F6298B967", ENDITEM, 
		LAST);
	...
	web_custom_request("shippingcost", 
		...
		"Body={\"seaddress\":{\"addressLine1\":\"768 9th. Avenue\",\"addressLine2\":\"\",\"city\":\"New york\",\"country\":\"us\",\"postalCode\":5521495,\"state\":\"New York\"},\"secustomerName\":\"David Morgan\",\"secustomerPhone\":529987145,\"senumberOfProducts\":5,\"setransactionType\":\"SHIPPING_COST\",\"sessionId\":\"8C0083850F93ED62C4C2DD7F6298B967\"}", 
		LAST);
