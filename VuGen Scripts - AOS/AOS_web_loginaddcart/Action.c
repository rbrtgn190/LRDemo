...
//	lr_output_message("unmaskedPwd : %s", lr_eval_string("{unmaskedPwd}"));
	...
	web_reg_find("Fail=NotFound",
		"Search=All",
		"Text/IC=reason>Login Successful",
		LAST);

/*Correlation comment - Do not change!  Original value='738747973' Name ='userId' Type ='Manual'*/
...
Original value='9D6B9FA529F6123C25CFB50307B5DBB5' 
Name ='sessionId' 
Type ='Rule' 
AppName ='AOS' 
...
/*Correlation comment - Do not change!  Original value='414141' Name ='productcode' Type ='RecordReplay'*/
	web_reg_save_param_json(
		"ParamName=productcode",
		"QueryString=$[0].products[0].colors[1].code",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);
	...
	web_custom_request("414141",
		"URL=http://{host_nimbusserver_aos_com_8002}/order/api/v1/carts/{userId}/product/20/color/{productcode}?quantity=1",
		"Method=OPTIONS",
		"Resource=0",
		"Referer=http://{host_nimbusserver_aos_com_8000}/",
		"Snapshot=t23.inf",
	...
	web_submit_data("414141_2",
		"Action=http://{host_nimbusserver_aos_com_8002}/order/api/v1/carts/{userId}/product/20/color/{productcode}?quantity=1",
		"Method=POST",
		"RecContentType=application/json",
		"Referer=http://{host_nimbusserver_aos_com_8000}/",
		"Snapshot=t24.inf",
	...
	web_custom_request("GetAccountByIdRequest_2",
		...
		"Mode=HTML",
		"EncType=text/xml; charset=UTF-8",
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><GetAccountByIdRequest xmlns=\"com.advantage.online.store.accountservice\"><accountId>{userId}</accountId><base64Token>Basic ZGF2aWRtOlBhc3N3MHJk</base64Token></GetAccountByIdRequest></soap:Body></soap:Envelope>",
		LAST);
	...
	web_custom_request("GetAccountByIdNewRequest_2",
		...
		"Mode=HTML",
		"EncType=text/xml; charset=UTF-8",
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><GetAccountByIdNewRequest xmlns=\"com.advantage.online.store.accountservice\"><accountId>{userId}</accountId><base64Token>Basic ZGF2aWRtOlBhc3N3MHJk</base64Token></GetAccountByIdNewRequest></soap:Body></soap:Envelope>",
		LAST);
	...
	web_custom_request("shippingcost_2",
		...
		"Body={\"seaddress\":{\"addressLine1\":\"768 9th. Avenue\",\"addressLine2\":\"\",\"city\":\"New york\",\"country\":\"us\",\"postalCode\":5521495,\"state\":\"New York\"},\"secustomerName\":\"David Morgan\",\"secustomerPhone\":529987145,\"senumberOfProducts\":1,\"setransactionType\":\"SHIPPING_COST\",\"sessionId\":\"{sessionId}\"}",
		LAST);
